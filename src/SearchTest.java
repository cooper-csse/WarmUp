...
public class SearchTest {
	...
	public void testBinarySearchFirstMid() {
		...
		assertEquals(3,  Search.search(this.smallArray, 13));
		correctnessCount+=1;
	}
	...
	public void testBinarySearchSecondMid() {
		...
		assertEquals(1,  Search.search(this.smallArray, 7));
		correctnessCount+=1;
	}
	...
	public void testBinarySearchSecondMid2() {
		...
		assertEquals(5,  Search.search(this.smallArray, 25));
		correctnessCount+=1;
	}

	@Test
	public void testBinarySearchAllArrayElements() {
		assertEquals(0,  Search.search(this.smallArray, 4));
		assertEquals(1,  Search.search(this.smallArray, 7));
		assertEquals(2,  Search.search(this.smallArray, 11));
		assertEquals(3,  Search.search(this.smallArray, 13));
		assertEquals(4,  Search.search(this.smallArray, 20));
		assertEquals(5,  Search.search(this.smallArray, 25));
		assertEquals(6,  Search.search(this.smallArray, 40));
		assertEquals(7,  Search.search(this.smallArray, 50));
		correctnessCount+=1;
	}
	
	@Test
	public void testBinarySearchItemNotInArray() {
		assertEquals(-1,  Search.search(this.smallArray, 3));
		assertEquals(-1,  Search.search(this.smallArray, 6));
		assertEquals(-1,  Search.search(this.smallArray, 19));
		assertEquals(-1,  Search.search(this.smallArray, 26));
		assertEquals(-1,  Search.search(this.smallArray, 39));
		assertEquals(-1,  Search.search(this.smallArray, 51));
		correctnessCount+=1;
	}
